...
namespace InterNation\gii\generators\model;
...
class Generator extends \yii\gii\Generator
{
    ...
    public $resourceNs = 'common\resources';
    public $generateResource = true;
    /**
     * @var string|null
     */
    public $queryClass;
    ...
    public function rules()
    {
        return array_merge(parent::rules(), [
                ...
                [['ns', 'baseClass', 'queryNs', 'resourceNs', 'queryBaseClass'], 'match', 'pattern' => '/^[\w\\\\]+$/', 'message' => 'Only word characters and backslashes are allowed.'],
                [['tableName'], 'match', 'pattern' => '/^([\w ]+\.)?([\w\* ]+)$/', 'message' => 'Only word characters, and optionally spaces, an asterisk and/or a dot are allowed.'],
                [['db'], 'validateDb'],
                [['ns', 'queryNs', 'resourceNs'], 'validateNamespace'],
                ...
                [
                    ['generateLabelsFromComments', 'useTablePrefix', 'useSchemaName', 'generateQuery', 'generateResource', 'generateRelationsFromCurrentSchema', 'useClassConstant', 'enableI18N', 'standardizeCapitals', 'singularize'],
                    'boolean'
                ],
    ...
    public function hints()
    {
        return array_merge(parent::hints(), [
            ...
            ',
                ...
                'resourceNs' => 'This is the namespace of the Resource class to be generated, e.g., <code>app\resources</code>',
            ]
        );
    }
    ...
    public function generate()
    {
        ...
        foreach ($this->getTableNames() as $tableName) {
            ...
            $resourceClassName = $this->generateResource ? $this->generateResourceClassName($modelClassName) : false;
            ...
            if ($resourceClassName) {
                $params['className'] = $resourceClassName;
                $params['modelClassName'] = $modelClassName;
                $files[] = new CodeFile(
                    Yii::getAlias('@' . str_replace('\\', '/', $this->resourceNs)) . '/' . $resourceClassName . '.php',
                    $this->render('resource.php', $params)
                );
            }
     ...
     * @return string
     */
    protected function generateResourceClassName(string $modelClassName)
    {
        return $modelClassName . 'Resource';
    }
